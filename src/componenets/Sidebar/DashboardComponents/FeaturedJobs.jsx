...
const FeaturedJobs = (props) => {
  ...
  return (
    <div className="h-[420px] w-[950px] bg-white-100 rounded-2xl shadow-md p-5 space-y-4">
      {/* Header with title */}
      ...
      <div className="flex justify-between items-start">
        <div>
          <h4 className="font-medium text-lg">{company} : HSBC,CITI Bank </h4>
          <p className="text-gray-600">
            {location} • {postedDate}
          </p>
        </div>
        <div className="text-right">
          <h2 className="text-[25 px] font-semibold text-[#212b36]">
            Salary Range
          </h2>
